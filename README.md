This project is a Contact Management App developed using ReactJS, TypeScript, TailwindCSS, React Router v6, and React Query (TanstackQuery). Follow the instructions below to set up and run the app locally.
# Deployed Link
